...
**Note on frontend tests**: The project currently has no frontend unit test framework configured. If this is still the case, note it as a gap rather than a failure.
