...
**First-time or shop install:** See the **[Installation Guide](docs/INSTALLATION_GUIDE.md)** for production deployment with pre-built Docker images, or development setup from source. Try the **[live demo](https://roblockwood.github.io/Shatter-NC/demo/)** or use the **[Install Kit generator](https://roblockwood.github.io/Shatter-NC/install/)** for Komodo deployments.
...
- **[Live demo](https://roblockwood.github.io/Shatter-NC/demo/)** — Interactive preview (Dashboard + Files)
- **[Installation Guide](docs/INSTALLATION_GUIDE.md)** — Shop install, backup, upgrade
- **[Install Kit generator](https://roblockwood.github.io/Shatter-NC/install/)** — Guided `.env` + compose for Komodo
