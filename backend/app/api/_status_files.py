"""File management routes — FTP programs, position, download, view, and upload.

Routes:
    GET  /{machine_id}/programs   — list files via FTP
    GET  /{machine_id}/position   — work offsets from POSNI1 via Telnet
    GET  /{machine_id}/download   — download file via FTP
    GET  /{machine_id}/metadata   — parse G-code metadata
