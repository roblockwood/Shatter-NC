...
def _clean_line(line: str) -> str:
    ...
    # Block-skip lines are ignored entirely.
...
def extract_tool_sequence(nc_content: str) -> List[int]:
    ...
    Each M6 or G100 event contributes exactly one entry.
    """
...
def build_transition_counts(tool_sequence: List[int]) -> Dict[Tuple[int, int], int]:
